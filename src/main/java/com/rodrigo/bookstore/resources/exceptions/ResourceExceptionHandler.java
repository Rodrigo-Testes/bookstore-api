...
public class ResourceExceptionHandler {
	...
	//tratando o erro de uma maneria Personalizada de MethodArgumentNotValidException
	@ExceptionHandler(MethodArgumentNotValidException.class)
	public ResponseEntity<StandardError> validatioError(MethodArgumentNotValidException e, ServletRequest request){
